...
Característica: Escenario 018 - Consulta integrada de Clima y Astronomía (HU-3 / HU-4)
  ...
  Escenario: Consulta de clima y astronomía para Bogotá
    ...
    Y navega mediante el menú a la pestaña de "Sun & Moon" (Sol y Luna)
    Entonces se visualizan las horas de salida y puesta del sol junto con la fase lunar actual de Bogotá